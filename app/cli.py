...
def parse_args():
    ...
    parser.add_argument('--train_file', type=str, help='Path to the input CSV file that is used for training the model (x_train).')
    parser.add_argument('-sg', '--save_generator', type=str, help='Filename to load a trained model from (does not perform training, just evaluate input data).')
    parser.add_argument('-sm', '--save_discriminator', type=str, help='Filename to save the trained model.')
    parser.add_argument('-op', '--optimizer_plugin', type=str, help='Name of the optimizer plugin to use.')
    parser.add_argument('-gp', '--generator_plugin', type=str, help='Name of the environment plugin to use.')
    parser.add_argument('-dp', '--discriminator_plugin', type=str,  help='Name of the agent plugin to use.')
