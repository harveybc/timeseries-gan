...
N_FEATURES = 5  # Number of features in the time series
...
VAE_MODEL_PATH = "models/vae/generator_model.h5" # Path to the VAE generator (decoder)
VAE_EPOCHS = 100
VAE_BATCH_SIZE = 32
...
GAN_TRAINING_MODE = False  # Set to true to run GAN training mode
GAN_MODEL_DIR = "models/gan"  # Directory to save/load GAN generator and discriminator
