...
- **Input (as part of the Composite GAN Generator)**: The VAE decoder expects multiple input streams prepared by the encapsulating Composite GAN Generator:
  ...
  - `decoder_input_h_context`: Context vector `(batch_size, 64)`. Dynamically populated using synthetic features generated at the *previous* timestep.
